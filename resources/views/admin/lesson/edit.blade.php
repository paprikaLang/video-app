            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item" style="display: flex; flex-direction: row;">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="lessontitle" required="required" value="{{$lesson['title']}}">
                        </div>
                    </li>
                    <li class="list-group-item" style="display: flex; flex-direction: row;">
                        <label for="" class="col-sm-2 control-label">课程简介</label>
                        <div class="col-sm-10">
                            <textarea name="desc" class="form-control" rows="1">{{$lesson['desc']}}</textarea>
                        </div>
                    </li>
                    <li class="list-group-item" style="display: flex; flex-direction: row;">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-1">
                                <input type="text" class="form-control  form-control-sm" name="preview" value="{{$lesson['preview']}}" readonly="" required>
